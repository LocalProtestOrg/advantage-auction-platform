...
const GROUPS = {
  ...
  material: {
    ...
    options: withNotSure([
      ...
      { key: 'ceramic',     label: 'Ceramic',      metadata: { field: 'material', value: 'Ceramic' } },
      { key: 'porcelain',   label: 'Porcelain',    metadata: { field: 'material', value: 'Porcelain' } },
...
const CATEGORY_CLARIFICATIONS = {
  ...
  'Pottery & Ceramics':   ['material', 'age', 'condition'],
  'Clocks & Timepieces':  ['working_status', 'age', 'condition'],
  'Tools':                ['working_status', 'material', 'condition'],
  'Lighting':             ['material', 'working_status', 'age', 'condition'],
