...
const DEFS = {
  ...
  auction_registered:       { kind: 'conversion', funnel: 'buyer', label: 'Registered for an auction', emitter: 'auctionRegistrationService.registerForAuction', meta_event: 'Subscribe', google_action: 'auction_registered', success_signal: true },
