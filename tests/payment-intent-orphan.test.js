...
describe('createPaymentIntent — Sub-batch 2 reorder', () => {
  ...
  function defaultTx1Setup() {
    ...
    mockClient.query.mockImplementation(async (sql) => {
      ...
      if (/SELECT a\.buyer_premium_bps, a\.platform_fee_bps AS snap_platform_bps/.test(sql)) {
        return { rows: [{ buyer_premium_bps: null, snap_platform_bps: null, snap_processing_bps: null, pricing_model: 'legacy', seller_type: 'private', seller_platform_bps: 400, buyer_premium_pct: null }] };
      }
