...
6.7 **Professional sellers — Buyer's Premium and seller fees.** For a Seller that Advantage has classified and approved as a professional seller (auction house, estate sale company, or professional liquidator), the Seller controls the Buyer's Premium applicable to the Seller's auctions, subject to Advantage's platform policies and any configured limits. The Buyer's Premium charged to buyers on the Seller's auctions is **retained by the Seller** (not by Advantage). In consideration for the marketplace, bidding platform, and related services, the professional Seller is charged two separate, independently itemized seller-side fees on total hammer-price sales:

- an **Advantage.Bid platform/software fee of 4% of the hammer price** (the "Platform Fee"); and
- a **credit-card/payment-processing fee of 3% of the hammer price** (the "Processing Fee"), reflecting card and payment processing costs.
...
7.3 **Payout schedule.** Advantage processes seller payouts on a weekly cycle, every **Thursday**. For an auction sale, the payout is processed on the first applicable Thursday **after** pickup/fulfillment is complete and the sale is otherwise eligible for payout. For Professional Storefront fixed-price sales, eligible sales completed by **Wednesday 11:59 PM** are processed in that week's Thursday payout cycle, subject to the fulfillment and eligibility rules the platform actually enforces. "Processed" refers to Advantage initiating the payout; the time for funds to arrive in the Seller's bank depends on the Seller's bank/ACH and is outside Advantage's direct control. Payouts remain subject to buyer payment collection, pickup/fulfillment completion, dispute resolution, chargeback review, fraud/compliance review, verification requirements, failed-transfer handling, and other standard settlement conditions; Advantage may hold or delay a payout while any such condition remains unresolved.
