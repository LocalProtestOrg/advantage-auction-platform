#!/usr/bin/env node
/* prod-migrate-081.js — PRODUCTION-guarded apply of ONLY 081_crm_foundation.sql. DO NOT run without approval.
 *   railway run --service advantage-auction-platform --environment production node scripts/prod-migrate-081.js */
...
(async () => {
  ...
  try {
    ...
    line(); console.log('POST ledger[081]: ' + (recorded ? 'recorded' : 'NOT recorded') + ' | tables_ok=' + v.tables_ok + ' cols(5)=' + v.cols);
