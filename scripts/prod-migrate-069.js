#!/usr/bin/env node
/* prod-migrate-069.js — PRODUCTION-guarded apply of ONLY 069_buyer_premium_billing_terms.sql.
...
(async()=>{const raw=process.env.DATABASE_URL||'';
  if(raw.includes('ep-royal-dawn-anarou3f')){console.error('REFUSE: wrong endpoint (PRODUCTION-only).');return 2;}
