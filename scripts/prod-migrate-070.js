#!/usr/bin/env node
/*
 * prod-migrate-070.js — PRODUCTION-guarded apply of ONLY 070_seller_agreement_gate.sql.
 ...
 *
 *   railway run --service advantage-auction-platform --environment production node scripts/prod-migrate-070.js
 */
const fs = require('fs');
