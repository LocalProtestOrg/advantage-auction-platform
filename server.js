...
const adminSettlementsRoutes = require('./src/routes/adminSettlements');
const sellerSettlementsRoutes = require('./src/routes/sellerSettlements');
...
const estateSaleRoutes          = require('./src/routes/estateSale');
...
const taxExemptionRoutes        = require('./src/routes/taxExemption');
...
const adminSalesRoutes          = require('./src/routes/adminSales');
const adminPricingRoutes        = require('./src/routes/adminPricing');
const adminStaffRoutes          = require('./src/routes/adminStaff');
...
app.use('/api/pricing-agreements', require('./src/routes/pricingAgreements'));
app.use('/api/marketing-packages', require('./src/routes/marketingPackages'));
...
app.use('/api/estate-sale', estateSaleRoutes);
